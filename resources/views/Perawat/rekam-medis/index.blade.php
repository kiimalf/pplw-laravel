<x-app-layout>
    ...
    <div class="mb-4 flex justify-end items-center gap-4">
        ...
        <a href=" {{ route('perawat.rekam-medis.create') }}"
                    ...
                    <tr class="text-center">
                        ...
                        <td class="px-6 py-3">
                            <div class="flex gap-2 justify-center">
                                ...
                                <a href="{{ route('perawat.rekam-medis.detail', $rekamMedis->idrekam_medis) }}"
                                    class="bg-orange-500 text-white px-4 py-1 rounded-lg hover:bg-orange-600 transition">
                                    detail
                                </a>

                                <form action="{{ route('perawat.rekam-medis.delete', $rekamMedis->idrekam_medis) }}"
                                    method="POST"
