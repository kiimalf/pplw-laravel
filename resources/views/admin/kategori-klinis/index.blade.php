        ...
        <table class="table-fixed min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-gray-900 dark:text-gray-100">
            ...
            <thead class="bg-gray-300 dark:bg-gray-700 ">
                <tr class="text-center">
                    ...
                    <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider">Nama Kategori Klinis</th>
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                @forelse ($kategoriKlinisS as $index => $kategoriKlinis)
                    <tr class="text-center">

                        <td class="px-6 py-3">{{ $loop->iteration }}</td>
                        <td class="px-6 py-3">{{ $kategoriKlinis->nama_kategori_klinis }}</td>

                        <td class="px-6 py-3">
                            <div class="flex gap-2 justify-center">

                                <a href="{{ route('admin.kategori-klinis.edit', $kategoriKlinis->idkategori_klinis) }}"
                                    class="bg-orange-500 text-white px-4 py-1 rounded-lg hover:bg-orange-600 transition">
                                    Edit
                                </a>

                                <form action="{{ route('admin.kategori-klinis.delete', $kategoriKlinis->idkategori_klinis) }}"
                                    method="POST"
...
<div class="app-content">
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header"><h3 class="card-title">Tabel Kategori Klinis</h3></div>
            ...
            <div class="card-body">
                <table class="table table-bordered table-hover table-sm align-middle">
                    ...
                    <tbody>
                        @forelse ($kategoriKlinisS as $row)
                        <tr class="text-center">
                            <td>{{ $loop->iteration }}</td>
                            <td>{{ $row->nama_kategori_klinis }}</td>

                            <td>
                                <a href="{{ route('admin.kategori-klinis.edit', $row->idkategori_klinis) }}"
                                    class="btn btn-warning btn-sm">Edit</a>

                                <form action="{{ route('admin.kategori-klinis.delete', $row->idkategori_klinis) }}"
                                      method="POST"
