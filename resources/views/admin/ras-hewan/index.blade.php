        ...
        <table class="table-fixed min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-gray-900 dark:text-gray-100">
            ...
            <thead class="bg-gray-300 dark:bg-gray-700 ">
                <tr class="text-center">
                    ...
                    <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider">Nama Jenis</th>
                    <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider">Nama Ras</th>
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                @forelse ($rasHewans as $index => $rasHewan)
                    <tr class="text-center">

                        <td class="px-6 py-3">{{ $loop->iteration }}</td>
                        <td class="px-6 py-3">{{ $rasHewan->nama_ras }}</td>
                        <td class="px-6 py-3">{{ $rasHewan->jenisHewan->nama_jenis_hewan }}</td>

                        <td class="px-6 py-3">
                            <div class="flex gap-2 justify-center">

                                <a href="{{ route('admin.ras-hewan.edit', $rasHewan->idras_hewan) }}"
                                    class="bg-orange-500 text-white px-4 py-1 rounded-lg hover:bg-orange-600 transition">
                                    Edit
                                </a>

                                <form action="{{ route('admin.ras-hewan.delete', $rasHewan->idras_hewan) }}"
                                    method="POST"
