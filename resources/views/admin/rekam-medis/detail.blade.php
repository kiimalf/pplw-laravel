<x-app-layout>
    ...
    <div class="overflow-x-auto bg-white dark:bg-gray-800 shadow rounded-xl mb-6 border-gray-300 dark:border-gray-700 border">
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse ($detailRekamMedis as $index => $detail)
                        <tr class="text-center">
                            ...
                            <td class="px-6 py-3">
                                <form action="{{ route('admin.detail-rekam-medis.delete', $detail->iddetail_rekam_medis) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus role ini?')">
                                    @csrf
                                    @method('DELETE')
        ...
        <form action="{{ route('admin.detail-rekam-medis.store') }}" method="POST" class="bg-white dark:bg-gray-800 shadow-md p-6 rounded-b-lg border-gray-300 dark:border-gray-700 border">
            @csrf
