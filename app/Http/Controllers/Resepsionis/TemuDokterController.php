...
class TemuDokterController extends Controller
{
    ...
    public function edit($idreservasi_dokter)
    {
        ...
        return view('resepsionis.temu-dokter.edit', compact('temuDokter', 'dokters'));
    }
    ...
    public function update(Request $request, $idreservasi_dokter)
    {
        ...
        return redirect()->route('resepsionis.temu-dokter.index')->with('success', 'Role berhasil diperbarui.');
    }
    public function delete($idreservasi_dokter)
    {
        ...
        return redirect()->route('resepsionis.temu-dokter.index')->with('success', 'Role berhasil dihapus.');
    }
}
