...
class DetailRekamMedisController extends Controller
{
    public function index($idrekam_medis)
    {
        ...
        return view('dokter.rekam-medis.detail', compact('detailRekamMedis', 'rekamMedis', 'kodeTindakan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dokter.rekam-medis.detail', $validated['idrekam_medis'])->with('success', 'Detail Rekam Medis berhasil ditambahkan.');
    }
    ...
    public function delete($iddetail_rekam_medis)
    {
        ...
        return redirect()->route('dokter.rekam-medis.detail', $idrekam_medis)->with('success', 'Detail Rekam Medis berhasil dihapus.');
    }
}
